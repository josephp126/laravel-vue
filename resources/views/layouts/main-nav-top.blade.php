        ...
        <ul id="nav" class="nav navbar-nav float-right">
            ...
            <li class="dropdown nav-item">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="dropdown-item"><a href="/">test 2</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href="/" class="nav-link">QUICK REFERENCE</a>
            </li>
            <li class="nav-item"><a href="/" class="nav-link">SELECTION TOOLS</a>
            </li>
